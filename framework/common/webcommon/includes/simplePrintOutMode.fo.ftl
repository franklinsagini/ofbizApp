                    ...
                    <fo:table-row>
                        ...
                        <fo:table-cell>
                            ...
                            <fo:list-block provisional-distance-between-starts="1in">
                                <fo:list-item>
                                    <fo:list-item-label>
                                        <fo:block font-weight="bold" font-size="9pt">CHAI SAVINGS AND CREDIT CO OPERATIVE SOCIETY LTD</fo:block>
                                         <fo:block font-size="9pt">Nairobi Branch: KTDA Plaza, Ground Floor,Tom Mboya Street</fo:block>
                                         <fo:block font-size="9pt">P.O. Box 278-00200 City Square Nairobi Kenya </fo:block>
                                         <fo:block font-size="9pt">Tel : 020 2214406/ 020 2214410 </fo:block>
                                         <fo:block font-size="9pt">Mobile: 0733 330045 / 0701 314410 </fo:block>
                                         <fo:block font-size="9pt">Email: fosa@chai-sacco.co.ke / info@chai-sacco.co.ke </fo:block>
                                         <fo:block font-size="9pt">Website : www.chai-sacco.co.ke </fo:block>
