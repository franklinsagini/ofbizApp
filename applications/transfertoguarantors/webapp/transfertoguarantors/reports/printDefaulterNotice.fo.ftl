...
<#escape x as x?xml>
 <#if loanApplication?has_content>
	...
	<fo:block font-size="12pt" text-align="center" margin-bottom="0.2in">
    	Kindly note that the recoveries will be effected to guarantors without further reference to yourself if accrued Payments are not remitted
	</fo:block>
	
	<fo:block font-size="12pt" text-align="center" margin-bottom="0.2in">
    	Below is the list of the guarantors of the above loan.
	</fo:block>
                    ...
                    <#list myGuarantorList as myGuarantorItem>
                        <fo:table-row>
                           ...
                           <fo:table-cell padding="2pt" border="1pt solid" border-width=".1mm">
                                ...
                                <#-- assign totalLoans = totalLoans+loanBalance -->
                                <#-- ${expectation.remitanceDescription?if_exists}  -->
                                ${bdAmountPerGuarantor?string(",##0.00")}
                               </fo:block>
                            </fo:table-cell>
