...
<#escape x as x?xml>
 ...
 <#if transactionList?has_content>
        ...
        <fo:block font-size="12pt" text-align="center"  font-weight="bold" >
           ${transactionType}  TRANSACTION REPORT 
        </fo:block>
            ...
            <fo:table table-layout="fixed" width="100%">
                ...
                <fo:table-header>
                    ...
                    <fo:table-row font-weight="bold">
                        ...
                        <fo:table-cell padding="2pt" background-color="#D4D0C8" border="1pt solid" border-width=".1mm">
                            <fo:block>Transaction Amount</fo:block>
                        </fo:table-cell>
                        <fo:table-cell padding="2pt" background-color="#D4D0C8" border="1pt solid" border-width=".1mm">
                    ...
                    <#list transactionList as transaction>
                        ...
                        <#assign count = count + 1>
                            ...
                            <fo:table-cell padding="2pt" border="1pt solid" border-width=".1mm">
                             ...
                             <fo:table-cell padding="2pt" border="1pt solid" border-width=".1mm">
	                              <#if transaction.memberAccountId?has_content>
	                               <#assign accNo = delegator.findOne("MemberAccount", {"memberAccountId",transaction.memberAccountId},false) /> 
		                                <fo:block> ${accNo.accountNo?if_exists} </fo:block>
		                              <#else>
		                               <fo:block> Not Def</fo:block>
	                               </#if>
                            </fo:table-cell>
                            
                            <fo:table-cell padding="2pt" border="1pt solid" border-width=".1mm">
                                  <#if transaction.memberAccountId?has_content>
	                               <#assign accName = delegator.findOne("MemberAccount", {"memberAccountId",transaction.memberAccountId},false) /> 
		                                <fo:block> ${accName.accountName?if_exists} </fo:block>
		                              <#else>
		                               <fo:block> Not Def</fo:block>
	                               </#if>
                            </fo:table-cell>
                             ...
                             <fo:table-cell padding="2pt" border="1pt solid" border-width=".1mm">
                                 <#if transaction.partyId?has_content>
	                               <#assign mobileNo = delegator.findOne("Member", {"partyId",transaction.partyId},false) /> 
		                                <fo:block> ${mobileNo.mobileNumber?if_exists} </fo:block>
		                              <#else>
		                               <fo:block> Not Def</fo:block>
	                               </#if>
                            </fo:table-cell>
                             ...
                             <fo:table-cell padding="2pt" border="1pt solid" border-width=".1mm">
                                <fo:block>${transaction.transactionAmount?if_exists}</fo:block>
                            </fo:table-cell>
                            
                            <fo:table-cell padding="2pt" border="1pt solid" border-width=".1mm">
                              <#if transaction.partyId?has_content>
	                               <#assign memNo = delegator.findOne("Member", {"partyId",transaction.partyId},false) /> 
		                                <fo:block> ${memNo.memberNumber?if_exists} </fo:block>
		                              <#else>
		                               <fo:block> Not Def</fo:block>
	                               </#if>
                            </fo:table-cell>
                             ...
                             <fo:table-cell padding="2pt" border="1pt solid" border-width=".1mm">
                                <fo:block>${transaction.createdStamp?if_exists}</fo:block>
                            </fo:table-cell>
