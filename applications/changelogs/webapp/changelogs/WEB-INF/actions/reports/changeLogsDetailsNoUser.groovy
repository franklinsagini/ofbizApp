...
changeLogs = delegator.findList("EntityAuditLog",  expr, null, ["changedDate ASC"], findOptions, false);
	 ...
	 changeLogs.eachWithIndex { changeLogsItem, index ->
      ...
      ChangeLogsNoUser.add([changeLogId :changeLogId,clientIpAddress :clientIpAddress, clientHostName : clientHostName, changeTime :changeTime, changedEntity :changedEntity, from : from, to : to, ChangedBy : ChangedBy]);
   
    }
            
context.ChangeLogsNoUser = ChangeLogsNoUser;
