...
<#if postingList?has_content>
        ...
        <fo:flow flow-name="xsl-region-body" font-family="Helvetica">
            <fo:block font-size="14pt">STAFF POSTINGS REPORT</fo:block>
            <#if !showSupplier>
                    ...
                    <#list postingList as postingList>
                        <fo:table-row>
                                ...
                                <fo:table-cell padding="2pt" background-color="${rowColor}">
                                 ...
                                 <fo:table-cell padding="2pt" background-color="${rowColor}">
                                    <fo:block>${postingList.branchId?if_exists}</fo:block>
                                </fo:table-cell>
                                <fo:table-cell padding="2pt" background-color="${rowColor}">
                                    <fo:block>${postingList.station?if_exists}</fo:block>
                                </fo:table-cell>
                                 <fo:table-cell padding="2pt" background-color="${rowColor}">
