...
<#escape x as x?xml>
 ...
 <#if staff?has_content>
        ...
        <fo:block font-size="12pt" text-align="center"  font-weight="bold" >
           ...
           ${branchName.groupName}   STAFF LISTING REPORT
                        ...
                        <#assign count = count + 1>
                            ...
                            <fo:table-cell padding="2pt" border="1pt solid" border-width=".1mm">
                             ...
                             <fo:table-cell padding="2pt" border="1pt solid" border-width=".1mm">
                               ...
                               <#assign jopPosition = delegator.findOne("EmplPositionType", {"emplPositionTypeId",employee.emplPositionTypeId},false) />
                                <fo:block> ${jopPosition.emplPositionType?if_exists}</fo:block>
                               <#else>
                               <fo:block> </fo:block>
                                </#if>
                            </fo:table-cell>
    ...
    <#else>
       ...
       <#-- REPORT TITLE -->
        ...
        <fo:block font-size="12pt" text-align="center"  font-weight="bold" >
           ...
           ${branchName.groupName} ${deptNameUpper}  STAFF LISTING REPORT
