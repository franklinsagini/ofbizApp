...
// if (memberStatusId)
	...
	expr = exprBldr.AND() {
		//GREATER_THAN_EQUAL_TO(createdStamp: startDateTimestamp)
		LESS_THAN_EQUAL_TO(disbursementDate: endDateTimestamp)
		EQUALS(employerCode: globalEmployerCode)
	}
...
myLoansList = delegator.findList("DefaultedUnattchedLoans", expr, null, ["createdStamp ASC"], findOptions, false)
...
//context.month = month
//stationEmployerItem
//myLoansList.eachWithIndex { loanItem, index ->
//
...
myLoansList.eachWithIndex { defaultedItem, defaultedItemIndex ->
	...
	if ((timeDefaulted != null) && (timeDefaulted > 3)){
		...
		defaultedLoan = [loanNo:defaultedLoan.loanNo, loanType:defaultedLoan.loanType, loanAmt:defaultedLoan.loanAmt, loanBalance:defaultedLoan.loanBalance, disbursementDate:defaultedLoan.disbursementDate,  lastPaid:defaultedLoan.lastPaid, payrollNo:defaultedLoan.payrollNo, name:defaultedLoan.name, memberStatus:defaultedLoan.memberStatus, timeDifference:defaultedLoan.timeDifference, shareAmount:defaultedLoan.shareAmount, termsOfService:defaultedLoan.termsOfService, mobileNumber:defaultedItem.mobileNumber, branchId:defaultedItem.branchId, stationId:defaultedItem.stationId]
