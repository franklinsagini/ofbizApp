...
if (stationId != null){
	...
	employerList = delegator.findByAnd("StationEmployer",  [employerCode : globalEmployerCode], null, false);
	
} else{
	employerList = delegator.findByAnd("StationEmployer",  null, null, false);
...
employerList.eachWithIndex { stationEmployerItem, index ->
	...
	employerCode = stationEmployerItem.employerCode;
	defaultedList = delegator.findByAnd("DefaultedLoans",  [employerCode : employerCode], null, false);
	...
	defaultedList.eachWithIndex { defaultedItem, defaultedItemIndex ->
		...
		defaultedLoan.timeDifference = org.ofbiz.accountholdertransactions.LoanUtilities.loanDefaultTimeDiff(defaultedItem.loanNo);
