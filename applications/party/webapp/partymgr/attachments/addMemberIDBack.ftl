 <script language="JavaScript" type="text/javascript">
    ...
    <h3>Add Member ID Back</h3>
    <form method="post" enctype="multipart/form-data" action="<@ofbizUrl>memberAttachments?partyId=${partyId}&amp;upload_file_type=original&amp;idbackurl=Y</@ofbizUrl>" name="imageUploadForm">
