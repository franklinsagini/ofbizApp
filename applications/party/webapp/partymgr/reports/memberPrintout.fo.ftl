...
<#-- Extra --> 
            <fo:list-item>
                <fo:list-item-label>
                    <fo:block font-weight="bold">Salutation</fo:block>
                </fo:list-item-label>
                <fo:list-item-body start-indent="body-start()">
                    <fo:block>${salutation.name}</fo:block>
                </fo:list-item-body>
            </fo:list-item>
            <fo:list-item>
                <fo:list-item-label>
                ...
                <fo:list-item-body start-indent="body-start()">
                    <fo:block>${gender.name}</fo:block>
                </fo:list-item-body>
            </fo:list-item>
            <fo:list-item>
                <fo:list-item-label>
                    <fo:block font-weight="bold">Marital Status</fo:block>
                </fo:list-item-label>
                <fo:list-item-body start-indent="body-start()">
                    <fo:block>${maritalStatus.name}</fo:block>
                </fo:list-item-body>
            </fo:list-item>
            <fo:list-item>
                <fo:list-item-label>
                ...
                <fo:list-item-body start-indent="body-start()">
                    <fo:block>${member.idNumber}</fo:block>
                </fo:list-item-body>
            </fo:list-item>
            <fo:list-item>
                <fo:list-item-label>
                    <fo:block font-weight="bold">Member Class</fo:block>
                </fo:list-item-label>
                <fo:list-item-body start-indent="body-start()">
                    <fo:block>${memberClass.name}</fo:block>
                </fo:list-item-body>
            </fo:list-item>
            <fo:list-item>
                <fo:list-item-label>
                    <fo:block font-weight="bold">Member Type</fo:block>
                </fo:list-item-label>
                <fo:list-item-body start-indent="body-start()">
                    <fo:block>${memberType.name}</fo:block>
                </fo:list-item-body>
            </fo:list-item>
            <fo:list-item>
                <fo:list-item-label>
            ...
            <fo:list-item>
                ...
                <fo:list-item-body start-indent="body-start()">
                    <fo:block>
                    ${member.birthDate?string["dd/MM/yyyy"]}
                    </fo:block>
                </fo:list-item-body>
            </fo:list-item>
            <fo:list-item>
                <fo:list-item-label>
                    <fo:block font-weight="bold">Date Joined</fo:block>
                </fo:list-item-label>
                <fo:list-item-body start-indent="body-start()">
                    <fo:block>${member.joinDate?string["dd/MM/yyyy"]}</fo:block>
                </fo:list-item-body>
            </fo:list-item>
