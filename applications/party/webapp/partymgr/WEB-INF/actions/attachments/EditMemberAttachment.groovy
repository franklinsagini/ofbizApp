...
imageFilenameFormat = UtilProperties.getPropertyValue('member', 'image.filename.format');
imageServerPath = FlexibleStringExpander.expandString(UtilProperties.getPropertyValue("member", "image.server.path"), context);
imageUrlPrefix = UtilProperties.getPropertyValue('member', 'image.url.prefix');
