...
memberTransactionsList = delegator.findList("AccountContributionDebitAmounts", expr, null, ["createdStamp ASC"], findOptions, false)


//myLoansList = delegator.findByAnd("LoanApplication",  [partyId : lpartyId, loanStatusId: disburseLoanStatusId], null, false);

context.debitsList = memberTransactionsList
