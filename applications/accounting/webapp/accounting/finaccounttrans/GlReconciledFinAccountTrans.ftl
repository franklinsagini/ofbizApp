...
<form id="glReconciledFinAccountTrans" name="glReconciledFinAccountTransForm" method="post" action="<@ofbizUrl>callReconcileFinAccountTrans?clearAll=Y</@ofbizUrl>">
  ...
  <div class="screenlet">
    ...
    <div class="screenlet-body">
      ...
      <a href="<@ofbizUrl>PrintFinAccountReconciliations?finAccountId=${finAccountId}&amp;glReconciliationId=${glReconciliationId}</@ofbizUrl>" class="buttontext">PRINT REPORT</a>
