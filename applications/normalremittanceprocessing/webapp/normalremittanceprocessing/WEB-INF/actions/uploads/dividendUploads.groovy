...
dividendYearId = parameters.dividendYearId;

println "######### The Dividend Year ID  is "+dividendYearId;
...
if (fileType) {
	println "######### The Dividend Year - for upload clicked is "+dividendYearId;
	...
	if (clientFileName && clientFileName.length() > 0) {
		...
		org.ofbiz.normalremittanceprocessing.NormalRemittanceProcessingServices.processDividendCSV(absoluteFileName, dividendYearId);
