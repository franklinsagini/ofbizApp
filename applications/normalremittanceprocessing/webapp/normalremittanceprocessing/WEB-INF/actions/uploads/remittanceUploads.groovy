...
normalRemittanceMonthYearId = parameters.normalRemittanceMonthYearId;

println "######### The Normal Remittance Month ID ONE  is "+normalRemittanceMonthYearId;
...
if (fileType) {
	println "######### The Salary Month ID TWO - for upload clicked is "+normalRemittanceMonthYearId;
	...
	if (clientFileName && clientFileName.length() > 0) {
		...
		org.ofbiz.normalremittanceprocessing.NormalRemittanceProcessingServices.processCSV(absoluteFileName, normalRemittanceMonthYearId);
