 <#-- script language="JavaScript" type="text/javascript">
    ...
    <h3>Upload Dividend File</h3>
    <form method="post" enctype="multipart/form-data" action="<@ofbizUrl>dividendImport?dividendYearId=${dividendYearId}&amp;upload_file_type=original&amp;photourl=Y</@ofbizUrl>" name="imageUploadForm">
