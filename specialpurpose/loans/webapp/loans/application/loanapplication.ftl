<div id="content">
  ...
  <table>
  	...
  	<tr><td>Member Type</td><td><input type="text" name="memberType" /></td></tr>
  	<tr><td>Member Number</td><td><input type="text" name="memberNumber" /></td></tr>
	...
	<tr><td>Interest Rate (Per Month)</td><td><input type="text" name="percentInterestPerMonthAmt" /></td></tr>
	<tr><td>Maximum Repayment Period</td><td><input type="text" name="maxRepaymentPeriod" /></td></tr>
	<tr><td>Loan Amount</td><td><input type="text" name="loanamt" /></td></tr>
	<tr><td>Repayment Period</td><td><input type="text" name="selectedRepaymentPeriod" /></td></tr>
